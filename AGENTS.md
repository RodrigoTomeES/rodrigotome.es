...
Copy `.env.template` to `.env`. Required vars: `SPOTIFY_CLIENT_ID`, `SPOTIFY_CLIENT_SECRET`, `SPOTIFY_REDIRECT_URL`, `SPOTIFY_REFRESH_TOKEN`, `GITHUB_USERNAME`, `FLICKR_API_KEY`, `FLICKR_PHOTOSET_ID`, `FLICKR_USER_ID`
